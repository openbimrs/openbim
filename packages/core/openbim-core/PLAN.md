# openbim-core implementation plan
...
Depends on nothing. A dependency here is compiled by every standard crate.
...
- [ ] `OBC-TYPES` - keep the shared vocabulary minimal; add a type only on a second consumer
