# openbim-codec-xml implementation plan
...
No workspace dependencies. Knows no schema and no standard.
...
- [ ] `OBX-TREE` - element tree for tree-shaped documents, once a standard crate needs one
