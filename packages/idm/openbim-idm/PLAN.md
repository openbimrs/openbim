# openbim-idm implementation plan
...
openbim-core plus openbim-codec-xml.
...
- [ ] `IDM-PORT` - port the lossless idmXML codec from poing; carry the recorded schema defects forward
