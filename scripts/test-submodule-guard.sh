...
children=(packages/ids packages/icdd packages/idm packages/loin packages/dt packages/cde packages/ifc packages/step packages/gaeb packages/citygml packages/openbimrl packages/bsdd packages/epd)
